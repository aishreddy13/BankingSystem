...
public class DbConnection {
    ...
    public static Connection getDBConnection() throws DBConnectionException {
        ...
        try {
            ...
            connection = (Connection) DriverManager.getConnection("jdbc:mysql://"+properties.getProperty("db.user")+":3306/Banking", properties.getProperty("db.username"), properties.getProperty("db.password"));
